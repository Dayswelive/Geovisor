...
//   // Check if specific layers are active
...
//               <TileLayer
//                 url="https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/wmts.cgi?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=MOD17A2_M_PSN&STYLE=default&TILEMATRIXSET=EPSG3857_250m&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT=image%2Fpng"
//                 attribution="NASA MODIS NPP"
//                 opacity={0.7}
//               />
//             </LayersControl.Overlay>
...
//               <TileLayer
//                 url="https://gis.wri.org/server/rest/services/Aqueduct/aqueduct_global_maps_20_data_download/MapServer/tile/{z}/{y}/{x}"
//                 attribution="World Resources Institute - Aqueduct Water Risk Atlas"
//                 opacity={0.7}
//               />
//             </LayersControl.Overlay>

//             {/* Precipitation with working CHIRPS data */}
//             <LayersControl.Overlay name="🌊 Precipitation (CHIRPS)">
//               <TileLayer
//                 url="https://iridl.ldeo.columbia.edu/maproom/.Global/.Precipitation/.CHIRPS/.Monthly/.Precipitation/X/Y/fig-/colors/plotaxislength/432/psdef/72/psdef//plotborder/0/psdef//XOVY/null/psdef/Y/-50/50/RANGE/X/-180/180/RANGE/{z}/{x}/{y}.png"
//                 attribution="CHIRPS Precipitation Data"
//                 opacity={0.7}
//               />
//             </LayersControl.Overlay>
...
//               <TileLayer
//                 url="https://services.terrascope.be/wms/v2?SERVICE=WMS&REQUEST=GetMap&VERSION=1.3.0&LAYERS=WORLDCOVER_2020_MAP&STYLES=&FORMAT=image/png&TRANSPARENT=true&HEIGHT=256&WIDTH=256&CRS=EPSG:3857&BBOX={bbox-epsg-3857}"
//                 attribution="ESA WorldCover"
//                 opacity={0.6}
//               />
//             </LayersControl.Overlay>

//             {/* Ecosystem Threats Layers */}
...
//             {/* Tree Cover */}
//             <LayersControl.Overlay name="🌳 Tree Cover (GFW)">
//               <TileLayer
//                 url="https://tiles.globalforestwatch.org/umd_tree_cover_density/v1.6/tcd_2010/{z}/{x}/{y}.png"
//                 attribution="Global Forest Watch - Tree Cover Density"
//                 opacity={0.7}
//                 maxZoom={12}
//               />
//             </LayersControl.Overlay>
...
//               <TileLayer
//                 url="https://map1.vis.earthdata.nasa.gov/wmts-geo/1.0.0/VIIRS_SNPP_DayNightBand_ENCC/default/2023-01-01/EPSG4326_500m/{z}/{y}/{x}.jpg"
//                 attribution="NASA VIIRS - Active Fires"
//                 opacity={0.8}
//               />
//             </LayersControl.Overlay>
...
//                 attribution="Biodiversity Reference Data"
//                 opacity={0.6}
//               />
//             </LayersControl.Overlay>
//           </LayersControl>
...
//       {/* CONDITIONAL: Layer Controls - Only show when corresponding layers are active */}
